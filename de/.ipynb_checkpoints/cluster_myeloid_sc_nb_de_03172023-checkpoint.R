...
#Run gene indices
res <- lapply(rownames(myeloid_rawcounts)[start:end], FUN=poisson_model_stats, sc_meta, myeloid_rawcounts)

#Save Results 
saveRDS(res, paste0('/data/srlab/ssg34/SLE_kidney_v2/data/DE/Myeloid_DE_cluster', cluster, "_", start, '_', end, '.rds'))
