...
meta <- readRDS("/data/srlab2/jmears/jupyter/SLE_Phase2_Kidney_Analysis/cell-seq-output/test/meta_removed_by_nonMTUMI.rds")

exprs_norm <- readRDS(paste("/data/srlab2/jmears/jupyter/SLE_Phase2_Kidney_Analysis/cell-seq-output/test/",
                            "normalized_data_all_filtered_removed_by_nonMTUMI.rds",
                            sep = ""))
...
#     scale_fill_viridis(option = "viridis", end = .9) +
    ...
    pdf(paste("/data/srlab2/jmears/jupyter/SLE_Phase2_Kidney_Analysis/cell-seq-output/expression_plots_test/",
        gene,
        "_exp_harm_test.pdf",
        sep = ""),
        height = 4,
