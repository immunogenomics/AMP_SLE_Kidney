...
meta <- readRDS("/data/srlab2/jmears/jupyter/SLE_Phase2_Kidney_Analysis/cell-seq-output/full_metadata/meta_all_corrected_overlap.rds")
...
## Read in filtered data
   ...
   data <- data[,colnames(data) %in% meta$cells]
...
saveRDS(data_full, paste("/data/srlab2/jmears/jupyter/SLE_Phase2_Kidney_Analysis/cell-seq-output/full_data/",
                           "data_all_corrected_overlap.rds",
                            sep = "")
       )
