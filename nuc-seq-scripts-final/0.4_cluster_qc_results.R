...
## Read in filtered_data
    data <- readRDS("../nuc-seq-output/full_data/data_all_filtered_500nGene_clusterremoval.rds")
## Read in metadata
    meta <- readRDS("../nuc-seq-output/full_metadata/meta_all_filtered_500nGene_clusterremoval.rds")
