...
meta$final_res.0.1 <- ids_ref_cca$res_0.10
meta$final_res.0.1 <- factor(meta$final_res.0.1, levels = sort(unique(meta$final_res.0.1)))
meta$final_res.0.4 <- ids_ref_cca$res_0.40
meta$final_res.0.4 <- factor(meta$final_res.0.4, levels = sort(unique(meta$final_res.0.4)))
meta$final_res.0.6 <- ids_ref_cca$res_0.60
meta$final_res.0.6 <- factor(meta$final_res.0.6, levels = sort(unique(meta$final_res.0.6)))
meta$final_res.0.8 <- ids_ref_cca$res_0.80
meta$final_res.0.8 <- factor(meta$final_res.0.8, levels = sort(unique(meta$final_res.0.8)))
meta$final_res.1.2 <- ids_ref_cca$res_1.20
meta$final_res.1.2 <- factor(meta$final_res.1.2, levels = sort(unique(meta$final_res.1.2)))
meta$final_res.1.6 <- ids_ref_cca$res_1.60
meta$final_res.1.6 <- factor(meta$final_res.1.6, levels = sort(unique(meta$final_res.1.6)))
meta$final_res.2.0 <- ids_ref_cca$res_2.00
meta$final_res.2.0 <- factor(meta$final_res.2.0, levels = sort(unique(meta$final_res.2.0)))
