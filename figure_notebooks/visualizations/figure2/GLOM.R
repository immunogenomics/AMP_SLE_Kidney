...
meta <- readRDS("../finalObjects/glom_meta.Rds")
...
meta$new_cluster_number <- substr(meta$final_annotation, 5, 5)
...
cowplot::save_plot("GLOM_Tissue_legend.pdf",
       legend,
       base_height = 10,
       base_width = 10)

pdf("GLOM_Tissue.pdf", width = 5, height = 5)
    print(p)
dev.off()