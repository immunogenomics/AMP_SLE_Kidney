...
meta <- readRDS("../finalObjects/loh_meta.Rds")
...
meta$new_cluster_number <- substr(meta$final_annotation, 4, 4)
...
cowplot::save_plot("LOH_Tissue_legend.pdf",
       legend,
       base_height = 10,
       base_width = 10)

pdf("LOH_Tissue.pdf", width = 5, height = 5)
    print(p)
dev.off()