...
plotType <- function(coVars, file) {
  meta <- read.csv(paste0('/data/srlab/ssg34/SLE_kidney_v2/data/pbmc/', name, '/', type, '/meta.csv'))
  umap <- read.csv(paste0('/data/srlab/ssg34/SLE_kidney_v2/data/pbmc/', name, '/', type, '/umap.csv'))
  ncorr <- read.csv(paste0("cna_results/", name, "/", file, "_", coVars, "_ncorr.csv"), header = FALSE)
  fdrs <- read.csv(paste0("cna_results/", name, "/", file, "_", coVars, "_fdrs.csv"), header = FALSE)
  ...
  print(paste0(min(meta$hUMAP1), ",", max(meta$hUMAP1)))
  print(paste0(min(meta$hUMAP2), ",", max(meta$hUMAP2)))
