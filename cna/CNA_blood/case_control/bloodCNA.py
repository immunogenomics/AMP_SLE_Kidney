...
harmony = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/pbmc/' + name + '/' + type + '/harmony.csv'))
meta = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/sugiarto_scripts/CNA_blood/new_metas/' + name + '/' + type + '/meta.csv'))
umap = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/pbmc/' + name + '/' + type + '/umap.csv'))
...
run_cna(var, d, "none")
run_cna(var, d, "corrected", covars)