...
harmony = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/' + name + '/chronicity/sc_harmony.csv'))
meta = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/' + name + '/chronicity/sc_meta.csv'))
umap = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/' + name + '/chronicity/sc_umap.csv'))

d = mad.MultiAnnData(X=harmony, obs=meta, sampleid="sample")

d.obs_to_sample(["Final_Chronicity", "First_biop", "Responder_Status", 
                 ...
                 "Final_Site_UCLA", "Final_Site_UCSF"])
...
chronicityCNA = run_cna('Final_Chronicity', d, "None")
chronicityCNA_FirstBiopResponse = run_cna('Final_Chronicity', d, "FirstBiopResponse", ['First_biop', "Responder_Status"])
chronicityCNA_SiteFirstBiop = run_cna('Final_Chronicity', d, "SiteFirstBiopsy", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop'])
chronicityCNA_SiteFirstBiopResponse = run_cna('Final_Chronicity', d, "SiteFirstBiopsyResponse", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop', "Responder_Status"])
