...
plotType <- function(coVars) {
  meta <- read.csv(paste0('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/', name, '/activity/sc_meta.csv'))
  umap <- read.csv(paste0('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/', name, '/activity/sc_umap.csv'))
  ncorr <- read.csv(paste0("cna_results/", name, "/Final_Activity_", coVars, "_ncorr.csv"), header = FALSE)
  fdrs <- read.csv(paste0("cna_results/", name, "/Final_Activity_", coVars, "_fdrs.csv"), header = FALSE)
...
plotType("SiteFBChron")
plotType("SiteFBChron_ISN_IV")
plotType("SiteFBChron_ISN_IV_V")
plotType("SiteFBChron_ISN_V")
plotType("SiteFBChron_Pred")
plotType("SiteFBChron_Resp")

dir.create("cna_percents")
write.csv(percents, paste0("cna_percents/", name, "_percents.csv"), row.names = FALSE)