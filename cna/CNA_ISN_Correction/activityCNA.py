...
activityCNA = run_cna('Final_Activity', d, "None")
activityCNA_chronicity = run_cna('Final_Activity', d, "FinalChronicity", ['Final_Chronicity'])
activityCNA_biopsy = run_cna('Final_Activity', d, "First_biop", ['First_biop'], )
activityCNA_isn = run_cna('Final_Activity', d, "ISN", ['Final_ISN_[III]', 'Final_ISN_[III][V]', 'Final_ISN_[IV]', 'Final_ISN_[IV][V]', 'Final_ISN_[V]'])
activityCNA_responder = run_cna('Final_Activity', d, "Responder_Status", ['Responder_Status'] )
