...
smallMeta <- read.csv(paste0('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/', smallName, '/ISN/sc_meta.csv'))
ncorr <- read.csv("../cna_results/myeloid/Final_ISN_[V]_SiteFirstBiopsy_ncorr.csv", header = FALSE)
fdrs <- read.csv("../cna_results/myeloid/Final_ISN_[V]_SiteFirstBiopsy_fdrs.csv", header = FALSE)
