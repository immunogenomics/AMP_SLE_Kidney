...
harmony = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/' + name + '/ISN/sc_harmony.csv'))
meta = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/' + name + '/ISN/sc_meta.csv'))
umap = pd.read_csv(('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/' + name + '/ISN/sc_umap.csv'))

d = mad.MultiAnnData(X=harmony, obs=meta, sampleid="sample")

d.obs_to_sample(["Final_ISN_[V]", "Race_[B]", "First_biop", "Final_Chronicity", "Final_Activity",
...
ISN_CNA = run_cna('Final_ISN_[V]', d, "None")

ISN_CNA_SiteFirstBiop = run_cna('Final_ISN_[V]', d, "SiteFirstBiopsy", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop'])

SN_CNA_SiteFirstBiop = run_cna('Final_ISN_[V]', d, "SiteFBChron", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop', 'Final_Chronicity'])

ISN_CNA_PredUse_Pred = run_cna('Final_ISN_[V]', d, "SiteFBChron_Pred", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop', 'Final_Chronicity', 'Pred_use'])

ISN_CNA_PredUse_Race = run_cna('Final_ISN_[V]', d, "SiteFBChron_Race", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop', 'Final_Chronicity', 'Race_[B]'])

ISN_CNA_PredUse_Activity = run_cna('Final_ISN_[V]', d, "SiteFBChron_Activity", 
                                              ["Final_Site_Einstein", "Final_Site_JHU", 
                                              "Final_Site_MUSC", "Final_Site_NYU", "Final_Site_Rochester", 
                                              "Final_Site_UCSF", 'First_biop', 'Final_Chronicity', 'Final_Activity'])