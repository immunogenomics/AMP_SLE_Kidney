...
sds <- slingshot(dPCs, clusterLabels = meta$annotation, start.clus = "bl-M0. CD14+ CD16- S100Ahigh")
saveRDS(sds, "destiny_slingshot_M0.Rds")
...
for (i in seq_along(lineages)) {
    ...
    pdf(paste0("slingshot/slingshot_UMAPs/lineage_", i, "/cellPlots", i, "_lineage.pdf"), width = 7, height = 7)
            print(ggplot(data = forBoxPlot, aes(x = Label, y = Pseudotime, fill = Label)) +
                geom_boxplot() +
                theme_minimal() +
