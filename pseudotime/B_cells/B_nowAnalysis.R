...
pdf("testDestiny_TSM.pdf", width = 6, height = 4.5)
...
for (i in seq_along(lineages)) {
 ...
 # Define a nice color palette
    ...
    pdf(paste0("M0_PT_correlations/lineage_", i, "/cellPlots", i, "_pseudotime.pdf"), width = 6, height = 5)
        print(
        ggplot() +
    ...
    # pdf("ITGAX_correlations.pdf", width = 6, height = 5) 
    #     ggplot()
    # dev.off()
