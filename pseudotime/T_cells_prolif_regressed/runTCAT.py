...
X = mmread("jointT.mtx").tocsr()  # or .tocsc()

obs = pd.read_csv("jointT_rows.txt", header=None, names=["cell_id"])
var = pd.read_csv("jointT_cols.txt", header=None, names=["gene_symbol"])
