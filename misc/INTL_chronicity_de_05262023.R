#@Script:INTL Chronicity DE Poisson Single-Cell Model
#@Author: Sid Gurajala
#@Date:05/26/2023
...
#Save Results 
saveRDS(res, paste0('/data/srlab/ssg34/SLE_kidney_v2/data/cna_new/INTL/chronicity/Chronicity_DE_', start, '_', end, '.rds'))
