...
saveRDS(var_genes, '/data/srlab/ssg34/SLE_kidney_v2/data/symphony_materials/B_Plasma_symphony_vargenes_07152024.rds')                    
...
weighted_pca_res <- weighted_pca(bp_scaled, weights, rownames(bp_scaled), 20, TRUE, 10)
saveRDS(weighted_pca_res, '/data/srlab/ssg34/SLE_kidney_v2/data/symphony_materials/B_Plasma_symphony_weighted_pca_res_07152024.rds')
...
reference = symphony::buildReferenceFromHarmonyObj(
        ...
        save_uwot_path = '/data/srlab/ssg34/SLE_kidney_v2/data/symphony_materials/bp_kidney_uwot_model_07162024') # filepath to save UMAP model)
                      
saveRDS(reference, '/data/srlab/ssg34/SLE_kidney_v2/data/symphony_materials/bp_kidney_symphony_reference_07162024.rds')